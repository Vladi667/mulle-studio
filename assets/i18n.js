...
(function () {
  ...
  FR[`When you submit the contact form, it is delivered to us by email through FormSubmit (formsubmit.co), which handles the submission on our behalf — we run no server of our own. We only receive what you choose to send, and keep it only as long as needed to reply.`] = `Lorsque vous envoyez le formulaire de contact, il nous parvient par e-mail via FormSubmit (formsubmit.co), qui traite l'envoi pour notre compte — nous n'exploitons aucun serveur. Nous ne recevons que ce que vous choisissez d'envoyer, et le conservons uniquement le temps nécessaire pour vous répondre.`;
